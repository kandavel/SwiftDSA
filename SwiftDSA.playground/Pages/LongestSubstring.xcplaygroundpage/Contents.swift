...
func findLongestSubstring(_ word: String) -> Int {
    ...
    for i in 0..<charArray.count {
        ...
        print("\nPrinting CharTable ::: \(charTable[currentChar])\n")
        print("\nLast DuplicateIndex :: \(lastDuplicateIndex)\n")
        if let charIndex = charTable[currentChar]  {
            print("\nSatisfly Condition ::: \(lastDuplicateIndex < charIndex)\n")
        }
